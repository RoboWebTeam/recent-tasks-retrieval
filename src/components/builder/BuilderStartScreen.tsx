...
export default function BuilderStartScreen({
  ...
  return (
    <div className="pt-1 pb-2">
          ...
          <div className="min-w-0">
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              {(ru
                ...
                <span
                  key={chip}
                  className="inline-flex items-center gap-1 rounded-full border border-border bg-background/70 px-2 py-0.5 text-2xs font-semibold text-muted-foreground"
                >
      ...
      <p className="mt-5 mb-2 text-2xs font-semibold uppercase tracking-widest text-muted-foreground">
        ...
        {PRODUCT_TYPES.map(p => {
          ...
          return (
            <button
              ...
              className={`lift group rounded-xl border p-3 text-left transition-colors ${
                active
      ...
      <div className="mb-2 flex gap-1 overflow-x-auto no-scrollbar">
        {PRODUCT_TYPES.map(p => (
          <button
            ...
            type="button"
            onClick={() => setTab(p.id)}
            className={`shrink-0 rounded-lg px-3 py-2 text-2xs font-semibold transition-colors ${
              tab === p.id
      ...
      <div className="space-y-1.5">
        {templates.map((t, i) => (
          <button
            ...
            className="at-in glow-hover group flex w-full items-center gap-3 rounded-xl border border-border bg-secondary/50 px-3 py-3 text-left transition-colors hover:border-primary/50 hover:bg-secondary disabled:cursor-not-allowed disabled:opacity-50"
          >
