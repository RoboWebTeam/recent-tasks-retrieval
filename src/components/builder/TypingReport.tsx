...
interface Props {
  ...
  steps?: string[];
  design?: string;
  /** Список секций/блоков созданного проекта */
  sections?: string[];
  ...
  animate: boolean;
  onTick: () => void;
  /** true — это правка существующего проекта, false — создание нового */
  isEdit?: boolean;
...
export default function TypingReport(props: Props) {
  ...
  // тоне и странно читается ПОСЛЕ готового проекта — ведём отчёт сразу с итога.
