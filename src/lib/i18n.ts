...
export const t = {
  ...
  loginHeroTitle: { ru: 'Ваша ИИ-команда\nуже за работой', en: 'Your AI team\nis already working' },
  loginHeroDesc: { ru: 'Войдите, чтобы продолжить работу над проектами: правки в диалоге, публикация, выгрузка кода и данные под вашим контролем.', en: 'Sign in to continue working on your projects: edits in chat, publishing, code export and data under your control.' },
  registerHeroTitle: { ru: 'Подключите свою\nИИ-команду разработки', en: 'Hire your own\nAI dev team' },
  registerHeroDesc: { ru: 'Регистрация — 30 секунд, карта не нужна. Первый проект бесплатно: опишите идею, а команда агентов соберёт фуллстек с базой и кодом.', en: 'Sign-up takes 30 seconds, no card needed. First project free: describe the idea and a team of agents builds a full-stack with a database and code.' },
  firstFree: { ru: 'Первый проект бесплатно', en: 'First website free' },
  ...
  createWithAI: { ru: 'Создать проект с ИИ', en: 'Create project with AI' },
  openBuilder: { ru: 'Открыть конструктор', en: 'Open Builder' },
  noProjects: { ru: 'Ещё нет проектов', en: 'No projects yet' },
  noProjectsDesc: { ru: 'Создайте первый проект — опишите идею в диалоге с ИИ.', en: 'Create your first project — describe your idea in AI chat.' },
  projectName: { ru: 'Название проекта', en: 'Website name' },
  ...
  builderWelcome: { ru: 'Опишите проект — и я создам его за секунды', en: 'Describe your site — I\'ll build it in seconds' },
  builderTryTitle: { ru: 'Попробуйте', en: 'Try these' },
  builderInputPlaceholder: { ru: 'Опишите ваш проект…', en: 'Describe your website…' },
  ...
  builderStep4: { ru: 'Пишу код и вёрстку', en: 'Writing code and layout' },
  builderStep5: { ru: 'Добавляю тексты и анимации', en: 'Adding content and animations' },
  builderStep6: { ru: 'Финальные штрихи и проверка', en: 'Final touches and review' },
  builderStepEdit1: { ru: 'Изучаю текущий проект', en: 'Reviewing current site' },
  builderStepEdit2: { ru: 'Применяю ваши правки', en: 'Applying your changes' },
  builderStepEdit3: { ru: 'Обновляю код', en: 'Updating the code' },
  builderEta: { ru: 'Обычно занимает 10–20 секунд', en: 'Usually takes 10–20 seconds' },
  builderEtaEdit: { ru: 'Обычно занимает 5–15 секунд', en: 'Usually takes 5–15 seconds' },
  builderElapsed: { ru: 'прошло', en: 'elapsed' },
  builderDone: { ru: 'Готово! Проект обновлён.', en: 'Done! Site updated.' },
  builderReady: { ru: 'Проект готов!', en: 'Site ready!' },
  ...
  builderPreviewEmptyDesc: { ru: 'Опишите проект в чате слева — и я сгенерирую его за несколько секунд', en: 'Describe your site in the chat on the left and I\'ll generate it in seconds' },
  builderCodeEmpty: { ru: 'Код появится после генерации проекта', en: 'Code will appear after site generation' },
  ...
  builderAiUnavailable: { ru: 'ИИ-сервис временно недоступен. Попробуйте через минуту или выберите другую модель.', en: 'AI service is temporarily unavailable. Try again in a minute or switch the model.' },
  ...
  blogCtaBtn:        { ru: 'Создать проект бесплатно', en: 'Create site for free' },
  blogCreate:        { ru: 'Создать проект', en: 'Create site' },
  // Article
  ...
  noDataDesc:         { ru: 'Статистика появится когда посетители начнут заходить на ваши проекты', en: 'Stats will appear when visitors start viewing your sites' },

  // --- SUGGESTIONS ---
  suggestion1: { ru: 'Лендинг для кофейни с меню и формой заказа', en: 'Coffee shop landing with menu and order form' },
  suggestion2: { ru: 'Визитка для фотографа', en: 'Portfolio website for a photographer' },
  ...
  suggestion5: { ru: 'Проект для барбершопа с записью', en: 'Barbershop site with booking' },
