...
const getStatusConfig = (lang: ReturnType<typeof getLang>) => ({
  ...
  building:  { label: tr('building', lang),  color: 'text-warning bg-warning/15',       icon: 'Loader' },
  published: { label: tr('published', lang), color: 'text-success bg-success/15',   icon: 'Globe' },
});
