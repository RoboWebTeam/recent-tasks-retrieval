...
import { L, getNAV, getFEATURES, getCOMPARE, getTRUST, getSTEPS, getPORTFOLIO, getPLANS, getFAQ, getMARQUEE, DEMO_CATEGORIES_RU, DEMO_CATEGORIES_EN, type DemoCategory } from './indexData';
...
function PortfolioSection({ lang, portfolio }: { lang: Lang; portfolio: ReturnType<typeof getPORTFOLIO> }) {
  ...
  // Сбрасываем позицию при смене фильтра
  useEffect(() => {
      ...
      <div className="container">
        ...
        <div className="relative">
          ...
          >
            ...
            {/* Пустой слот в конце для удобства скролла */}
