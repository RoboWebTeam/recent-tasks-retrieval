...
export const getPLANS = (lang: Lang) => lang === 'ru' ? [
  ...
  { name: 'Профи', badge: '', price: '2 999 ₽', note: 'в месяц', tag: '60 запросов в месяц', features: ['Приоритетная поддержка','Все возможности Премиум','Облачный хостинг','До 5 проектов','База данных 1 ГБ','Хранилище 5 ГБ','25 функций','250 ч вычислений'], cta: 'Выбрать Профи', hot: false },
  { name: 'Профи', badge: '', price: '4 999 ₽', note: 'в месяц', tag: '80 запросов в месяц', features: ['Приоритетная поддержка','Все возможности Премиум','Облачный хостинг','До 8 проектов','База данных 1 ГБ','Хранилище 10 ГБ','50 функций','417 ч вычислений'], cta: 'Выбрать Профи', hot: false },
  { name: 'Профи', badge: '', price: '9 999 ₽', note: 'в месяц', tag: '200 запросов в месяц', features: ['Приоритетная поддержка','Все возможности Премиум','Облачный хостинг','До 10 проектов','База данных 2 ГБ','Хранилище 20 ГБ','100 функций','833 ч вычислений'], cta: 'Выбрать Профи', hot: false },
  { name: 'Профи', badge: '', price: '19 999 ₽', note: 'в месяц', tag: '400 запросов в месяц', features: ['Приоритетная поддержка','Все возможности Премиум','Облачный хостинг','До 20 проектов','База данных 4 ГБ','Хранилище 40 ГБ','200 функций','1667 ч вычислений'], cta: 'Выбрать Профи', hot: false },
  { name: 'Профи', badge: '', price: '49 999 ₽', note: 'в месяц', tag: '800 запросов в месяц', features: ['Приоритетная поддержка','Все возможности Премиум','Облачный хостинг','До 50 проектов','База данных 10 ГБ','Хранилище 100 ГБ','500 функций','4167 ч вычислений'], cta: 'Выбрать Профи', hot: false },
] : [
  ...
  { name: 'Pro', badge: '', price: '2 999 ₽', note: 'per month', tag: '60 requests/month', features: ['Priority support','All Premium features','Cloud hosting','Up to 5 projects','1 GB database','5 GB storage','25 functions','250h compute'], cta: 'Choose Pro', hot: false },
  { name: 'Pro', badge: '', price: '4 999 ₽', note: 'per month', tag: '80 requests/month', features: ['Priority support','All Premium features','Cloud hosting','Up to 8 projects','1 GB database','10 GB storage','50 functions','417h compute'], cta: 'Choose Pro', hot: false },
  { name: 'Pro', badge: '', price: '9 999 ₽', note: 'per month', tag: '200 requests/month', features: ['Priority support','All Premium features','Cloud hosting','Up to 10 projects','2 GB database','20 GB storage','100 functions','833h compute'], cta: 'Choose Pro', hot: false },
  { name: 'Pro', badge: '', price: '19 999 ₽', note: 'per month', tag: '400 requests/month', features: ['Priority support','All Premium features','Cloud hosting','Up to 20 projects','4 GB database','40 GB storage','200 functions','1667h compute'], cta: 'Choose Pro', hot: false },
  { name: 'Pro', badge: '', price: '49 999 ₽', note: 'per month', tag: '800 requests/month', features: ['Priority support','All Premium features','Cloud hosting','Up to 50 projects','10 GB database','100 GB storage','500 functions','4167h compute'], cta: 'Choose Pro', hot: false },
];
