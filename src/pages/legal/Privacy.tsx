...
export default function Privacy() {
  ...
  return (
    <LegalPageLayout title="Политика конфиденциальности" updatedAt="4 июля 2026 г.">
      ...
      <p>
        1.5. Создаваемый вами контент: проекты проектов, сгенерированный HTML-код, загруженные и созданные
      ...
      <ul>
        ...
        <li><strong>поставщики ИИ-сервисов</strong> — текст ваших сообщений в чате передаётся сторонним
          поставщикам ИИ для генерации контента проекта; эти поставщики обрабатывают текст запроса, но не вправе
          использовать его для иных целей, кроме генерации ответа;</li>
        <li><strong>Яндекс.Метрика</strong> — обезличенные данные об использовании проекта;</li>
